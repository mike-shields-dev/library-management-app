...
public class Book implements Displayable, IDNumber {
	 ...
	 * 
	 * @param isbnNumber - The book's ISBN number (int)
	 * 
	 * @throws IllegalArgumentException - If any parameters are invalid, 
	 *                                    in accordance with the Book's
	 *                                    Mutator methods
	 */
	 ...
	 * @param idNumber - The book's idNumber (int)
	 * @throws IllegalArgumentException - If any parameters are invalid, 
	 *                                    in accordance with the Book's
	 *                                    Mutator methods
	 */
	 ...
	 * @param isbnNumber - The book's ISBN number (String)
	 * 
	 * @throws IllegalArgumentException - If isbnNumber is null, 
	 ...
	 * 
	 * @throws IllegalArgumentException - If the idNumber is a negative integer
	 */
	@Override
	 ...
	 * (implementation of the IDNumber interface's getIDNumber method)
	 * 
